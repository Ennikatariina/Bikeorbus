...
const MuutaTietoja = () => {
    ...
    const [lowestTemperature, setLowestTemperature] = useState(personalInformation.lowestTemperature);
    ...
    const [slipperyConditions, setSlipperyConditions] = useState(personalInformation.slipperyConditions);
    ...
    const handleAddData = async () => {
        ...
        try {
            ...
            Alert.alert('Virhe tallennuksessa', 'Pahoittelut mutta jotain meni pieleen.');
        }
    };
